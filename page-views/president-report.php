...
<div class="section-title archives">
    <h2>Latest President's Report</h2>
 </div>
...
?>
 <div class="president-report-boxes">
 <div class ="box-president-report">
...
<div class ="box-president-report">
  <div class="box-content">
    <div class="text-content">
      <h4 class="Date-text">April 28 2025</h4>
        <a href="updates?page-view=president-report&article-view=true" class="clickable-text inter-black">2nd President's Report</a>
        <!-- <a href="../page-views/updates/announcements-article-view.php" class="clickable-text inter-black"><?php echo $articleSample['header'];?></a> -->
      <h4>SDG Goals:</h4> 
